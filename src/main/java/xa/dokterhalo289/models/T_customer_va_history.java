...
public class T_customer_va_history {
	@Id
	...
	@ManyToOne
    @JoinColumn(name = "customer_va_id", insertable = false, updatable = false)
    public T_customer_va t_customer_va;

	@Nullable
    @Column(name = "customer_va_id", length = 10)
    public Long customer_va_id;
